...
enum BattlegroundTAObjectTypes
{
    ...
    BG_TA_OBJECT_DOOR_3         = 2,
    BG_TA_OBJECT_DOOR_4         = 3,
    BG_TA_OBJECT_BUFF_1         = 4,
    BG_TA_OBJECT_BUFF_2         = 5,
    BG_TA_OBJECT_MAX            = 6
};

enum BattlegroundTAObjects
{
    BG_TA_OBJECT_TYPE_DOOR_1    = 183971,
    BG_TA_OBJECT_TYPE_DOOR_2    = 183973,
    BG_TA_OBJECT_TYPE_DOOR_3    = 183970,
    BG_TA_OBJECT_TYPE_DOOR_4    = 183972,
