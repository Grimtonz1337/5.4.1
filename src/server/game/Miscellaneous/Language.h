...
enum TrinityStrings
{
    ...
    LANG_BG_TP_START_TWO_MINUTES        = 639,
    LANG_BG_TP_START_ONE_MINUTE         = 640,
    LANG_BG_TP_START_HALF_MINUTE        = 641,
    LANG_BG_TP_HAS_BEGUN                = 642,
    ...
    LANG_BG_BG_START_TWO_MINUTES        = 754,
    LANG_BG_BG_START_ONE_MINUTE         = 661,
    LANG_BG_BG_START_HALF_MINUTE        = 662,
    LANG_BG_BG_HAS_BEGUN                = 663,
    LANG_BG_BG_A_NEAR_VICTORY           = 664,
    LANG_BG_BG_H_NEAR_VICTORY           = 665,

    LANG_BG_BG_NODE_LIGHTHOUSE          = 653,
    LANG_BG_BG_NODE_WATERWORKS          = 654,
    LANG_BG_BG_NODE_MINES               = 655,
